...
const PERMISSOES_POR_MODULO = {
  ...
  [MODULOS.VICE_DIRETORES]: [PERFIS.DIRETOR, PERFIS.DIRECAO],
  [MODULOS.SUPERVISAO]: [PERFIS.DIRETOR, PERFIS.DIRECAO, PERFIS.VICE_DIRETOR],
};
