...
create table public.ocorrencias (
  ...
  observacao text,
  solicitar_responsavel boolean not null default false,
  responsavel_compareceu boolean not null default false,
  responsavel_compareceu_por text,
  responsavel_compareceu_em timestamptz,
